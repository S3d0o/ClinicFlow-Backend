        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DoctorSchedules_Doctors_DoctorProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppointmentSlots_DoctorSchedules_DoctorScheduleId",
                        column: x => x.DoctorScheduleId,
                        principalTable: "DoctorSchedules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppointmentSlots_Doctors_DoctorProfileId",
                        column: x => x.DoctorProfileId,
                        principalTable: "Doctors",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Reviews_Patients_PatientProfileId",
                        column: x => x.PatientProfileId,
                        principalTable: "Patients",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppointmentSlots_DoctorProfileId_Date_StartTime",
                table: "AppointmentSlots",
                columns: new[] { "DoctorProfileId", "Date", "StartTime" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AppointmentSlots_DoctorProfileId_Date_Status",
                table: "AppointmentSlots",
                columns: new[] { "DoctorProfileId", "Date", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_AppointmentSlots_DoctorScheduleId",
                table: "AppointmentSlots",
